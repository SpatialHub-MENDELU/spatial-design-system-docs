    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: 'Appearance', link: '/guidelines/appearance', items: [
          ...
          {
            text: 'Behavior', link: '/guidelines/behavior',
            items: [
          ...
          {
            text: 'Menu Type', link: '/guidelines/menu-type',
            items: [
              {text: '3D menu', link: '/guidelines/3d-menu'},
              {text: 'Bottom sheet', link: '/guidelines/bottom-sheet'},
              {text: 'Floating buttons', link: '/guidelines/floating-buttons'},
