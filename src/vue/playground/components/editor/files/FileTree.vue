<template>
  <div class="border-r border-border-color">
    ...
    <Tree :value="folders" @contextMenu="showContextMenu"
...
const contextMenuItems = ref([
  { label: 'Open', icon: 'pi pi-folder-open', command: () => openItem(currentItem.value) },
  { label: 'Delete', icon: 'pi pi-trash', command: () => deleteItem(currentItem.value) },
]);
