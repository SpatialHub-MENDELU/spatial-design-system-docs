...
export const lessonsData: ILessonVariants[] = [
  ...
  },
  {
    ...
    vueVariant: {
      content: {
        intro: `<p>
        Welcome to this lesson on the <span>AR Button Component</span>! In this course, you will learn how to use and customize the <span>&lt;a-ar-button&gt;</span> component from the Spatial Design System. This button is designed for AR environments and provides a visually cohesive, interactive experience.
      </p>`,
      whatYouWillLearn: `
      <p>By the end of this lesson, you will:</p>
            <ul class="lesson-detail--list">
              <li>Understand the purpose of the <span>&lt;a-ar-button&gt;</span> component,</li>
  ...
  },
  {
    ...
    vueVariant: {
      content: {
        ...
        <ul class="lesson-detail--list">
          <li><span>Visibility:</span> The visible property determines whether the checkbox appears in the AR scene or not.</li>
          <li><span>Size:</span> Adjust the checkbox's size with the size property to make it easier to interact with, especially on mobile or VR devices.</li>
          <li><span>Color:</span> The primary color can be changed to match the color scheme of your application, making it blend in or stand out.</li>
          <li><span>State:</span> The value property reflects whether the checkbox is checked (true) or unchecked (false).</li>
          <li><span>Variant:</span> The variant property allows you to customize the color scheme of the checkbox, making it fit into either a light or dark mode for the UI.</li>
        </ul>
        `,
        ...
        <ul class="lesson-detail--list">
          <li>Modify the checkbox's color:
            <ul class="lesson-detail--list">
              <li>Set primary to <span>#FF6347</span>.</li>
            </ul>
          </li>
          <li>Modify the checkbox's size:
            <ul class="lesson-detail--list">
              <li>Set the size property to <span>small</span>.</li>
            </ul>
          </li>
          <li>Position the checkbox in the scene:
            <ul class="lesson-detail--list">
              <li>Set the position property to <span>0 2 -4</span>.</li>
            </ul>
          </li>
          <li>Test a specific color scheme for the checkbox:
            <ul class="lesson-detail--list">
              <li>Set the variant property to <span>dark</span>.</li>
            </ul>
          </li>
          <li>Change the checkbox's state:
            <ul class="lesson-detail--list">
              <li>Set the value property to <span>true</span> (checked state).</li>
            </ul>
          </li>
        </ul>`
      },
