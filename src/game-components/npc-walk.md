...
The _npc-walk_ component rely on the Ammo.js physics engine. Ensure that Ammo.js is installed in your project for proper functionality.
:::
...
| _type_                 | enum (randomMoving, points) | randomMoving                      | Defines how the character moves.  |    |
