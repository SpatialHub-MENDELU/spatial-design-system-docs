...
<template #output v-if="renderScene">
    <a-ar-card 
        ...
        buttons='[{"label": "cancel", "action": "cancel"}, {"label": "save", "action": "save"}]' 
    ></a-ar-card>
</template>
...
| _title_     | string                     | “Card Title” | Sets the card's title text.            |
| _subtitle_  | string                     | “Subtitle”   | Sets the card's subtitle text.         |
| _content_   | string                     | "This is an example of the basic card component."     | Sets the card's main text. |
